...
export const MOCK_ARTICLES: ArticleType[] = [
  {
    ...
    content: `Accessibility in React starts with semantic HTML, keyboard navigation, and focus management. In this short article, we cover practical tips you can adopt today to make your UI usable by everyone.

Check out this short overview on inclusive UI:
[yt-embed:https://www.youtube.com/watch?v=dQw4w9WgXcQ]

We also share a sample component to get you started with accessible patterns.`,
    ...
    fileEmbeds: [
      {
        ...
        uploadedAt: new Date('2024-06-12T09:00:00.000Z'),
        width: 1280,
        height: 720,
        alt: 'Team collaborating at a desk',
        title: 'Collaboration',
        caption: 'Working together on accessible solutions',
        loading: 'lazy',
      },
    ],
    seo: {
  ...
  },
  {
    ...
    content: `Zod bridges runtime validation and static type inference. Define schemas once, parse external data safely, and rely on inferred types. This article shows a minimal setup and a couple of handy patterns for forms and APIs.

Here's a simple Zod schema example:
[cp-embed:https://codepen.io/pen/abCDefg]

And here's the full implementation:
[gh-gist:https://gist.github.com/notreallyuri/0123456789abcdef0123456789abcdef]`,
    tags: ['zod', 'typescript'],
    status: 'published',
  ...
  },
  {
    ...
    content: `Next.js apps benefit from strategic caching, granular data fetching, and streaming UI. In this quick guide, we cover a few patterns you can apply incrementally, with links to examples and small demos.

Here's a live demo with streaming UI:
[sb-embed:https://stackblitz.com/edit/nextjs-starter?file=app/page.tsx]

And here's what the Vercel team has to say about it:
[tw-embed:https://twitter.com/vercel/status/1508890164219987968]`,
    ...
    fileEmbeds: [
      {
        ...
        uploadedAt: new Date('2024-09-10T15:00:00.000Z'),
        title: 'Soft background track',
        caption: 'Sample audio for testing',
        duration: 180,
        controls: true,
        autoplay: false,
        loop: false,
      ...
      {
        id: 'f4e6a0b1-2c3d-4e5f-9601-2a3b4c5d6e78',
        type: 'document',
        filename: 'spec-sheet.pdf',
        fileSize: 1_500_000,
        mimeType: 'application/pdf',
        url: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
        uploadedAt: new Date('2024-09-10T15:30:00.000Z'),
        title: 'Specification Document',
        caption: 'Technical specifications (PDF)',
        pageCount: 12,
        downloadable: true,
      },
    ],
  },
  {
    ...
    content: `JavaScript offers versatile async primitives. Promises, async/await, and structured concurrency enable responsive UIs and scalable servers. Here are a few tips and caveats that keep code predictable.

    Here's a short explainer on event loops:
    [vimeo-embed:https://vimeo.com/76979871]`,
    ...
    fileEmbeds: [
      {
        id: 'a7c1d9f2-0b3a-4d7e-9e5a-1f2a3b4c5d67',
        type: 'image',
        filename: 'developer-laptop.jpg',
        fileSize: 1_800_000,
        mimeType: 'image/jpeg',
        url: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1600&auto=format&fit=crop',
        uploadedAt: new Date('2024-03-18T08:00:00.000Z'),
        width: 1400,
        height: 933,
        alt: 'Developer working at a laptop',
        title: 'Development Environment',
        caption: 'Modern development setup',
        loading: 'lazy',
      },
    ],
  },
