  ...
  if (!isClient) {
    return (
      <div className={`flex justify-center ${className}`}>
        <div
          className="animate-pulse rounded-lg border bg-muted"
          style={{
            height: '600px',
            maxWidth: '540px',
            minWidth: '326px',
...
const processInstagramEmbed = (url: string, key: string) => {
  ...
  return (
    ...
    >
      <p className="text-sm">
        ⚠️ Invalid Instagram URL: <code className="text-xs">{url}</code>
      </p>
    </div>
  );
};

export { InstagramEmbed, INSTAGRAM_PATTERNS, processInstagramEmbed };
