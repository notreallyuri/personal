...
export function ArticleCard({ article }: ArticleCardProps) {
  ...
  return (
    <Link href={`/articles/${article.slug}`}>
      <article className="group relative rounded-lg border bg-background p-4 shadow transition-all duration-200 hover:border-primary/50 hover:shadow-md dark:bg-accent">
