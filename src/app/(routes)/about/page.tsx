      ...
      <div className="grid gap-8 md:grid-cols-2">
        <Card className="transition-all duration-300 hover:shadow-lg">
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <div className="mt-auto flex h-fit flex-wrap gap-2 pt-2">
              ...
              <div className="space-y-3" key={group.title}>
                ...
                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-4">
                  {group.skills.map((skill) => (
                    <div
                      className="flex h-12 select-none items-center justify-center rounded-lg border border-border/50 bg-secondary/50 px-3 py-2 font-medium text-secondary-foreground text-sm transition-all duration-200 hover:scale-105 hover:border-primary/30 hover:bg-secondary/70 hover:shadow-sm"
                      key={skill}
                    >
                      {skill}
                    </div>
